...
(function(window) {
    ...
    Tab.prototype.init = function() {
        ...
        this.tabtitle = this.tab.querySelectorAll('.detail-item');
        this.tabcontent = this.tab.querySelectorAll('.clearfix');
    ...
    Tab.prototype.tabswitch = function() {
        for (var i = 0; i < this.tabtitle.length; i++) {
            ...
            this.tabcontent[i].className = 'clearfix';
        }
        this.tabtitle[this.num].className = 'active';
        this.tabcontent[this.num].className = 'clearfix show';
    }
